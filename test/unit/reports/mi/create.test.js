...
} = require("../../../../app/reports/mi/get-report-lines");
    ...
    [
      ...
      () =>
        expect(mockWriteFile).toHaveBeenCalledWith(
          reportsConfig.miReportName,
          csv,
        ),
    ],
    [
      "writes csv file once",
