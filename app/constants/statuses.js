module.exports = {
  ...
  PAYMENT_FAILED_QUALITY_CHECK_STATUS: 'Ledger assignment quality check failed, waiting for correction',
  PAYMENT_PASSED_QUALITY_CHECK_STATUS: 'Ledger assignment quality check passed',
